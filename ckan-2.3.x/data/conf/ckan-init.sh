...
# install ckan
pip install -e 'git+https://github.com/ckan/ckan.git@ckan-2.3.3#egg=ckan'
...
## Install extensions
pip install ckanext-pdfview ckanext-geoview
...
# needs geos (libgeos-dev), postgis and a bunch of db configuration
